...
namespace AdvancedInspector
{
    ...
    public class RendererEditor : InspectorEditor
    {
        protected override void RefreshFields()
        {
            ...
            fields.Add(new InspectorField(type, Instances, type.GetProperty("castShadows"),
                new DescriptorAttribute("Cast Shadows", "Does this object cast shadows?", "http://docs.unity3d.com/ScriptReference/Renderer-castShadows.html")));
            ...
            fields.Add(new InspectorField(type, Instances, type.GetProperty("lightProbeAnchor"), new InspectAttribute(new InspectAttribute.InspectDelegate(IsUsingLightProbe)),
                new DescriptorAttribute("Light Probes Anchor", "If set, Renderer will use this Transform's position to find the interpolated light probe.", "http://docs.unity3d.com/ScriptReference/Renderer-lightProbeAnchor.html")));
