...
namespace AdvancedInspector
{
    ...
    public class RigidbodyEditor : InspectorEditor
    {
        protected override void RefreshFields()
        {
            ...
            fields.Add(new InspectorField(type, Instances, type.GetProperty("sleepVelocity"), new InspectAttribute(InspectorLevel.Advanced),
                new DescriptorAttribute("Sleep Velocity", "The linear velocity, below which objects start going to sleep. (Default 0.14) range { 0, infinity }", "https://docs.unity3d.com/Documentation/ScriptReference/Rigidbody-sleepVelocity.html")));
            fields.Add(new InspectorField(type, Instances, type.GetProperty("sleepAngularVelocity"), new InspectAttribute(InspectorLevel.Advanced),
                new DescriptorAttribute("Sleep Angular Velocity", "The angular velocity, below which objects start going to sleep. (Default 0.14) range { 0, infinity }", "https://docs.unity3d.com/Documentation/ScriptReference/Rigidbody-sleepAngularVelocity.html")));
