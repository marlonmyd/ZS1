...
namespace AdvancedInspector
{
    ...
    public class MeshColliderEditor : ColliderEditor
    {
        protected override void RefreshFields()
        {
            ...
            fields.Add(new InspectorField(type, Instances, type.GetProperty("smoothSphereCollisions"),
                new DescriptorAttribute("Smooth Sphere Collisions", "Uses interpolated normals for sphere collisions instead of flat polygonal normals.", "http://docs.unity3d.com/ScriptReference/MeshCollider-smoothSphereCollisions.html")));
