...
namespace AdvancedInspector
{
    ...
    public class JointSpringEditor : InspectorEditor
    {
        protected override void RefreshFields()
        {
            ...
            fields.Add(new InspectorField(type, Instances, type.GetField("damper"),
            ...
            fields.Add(new InspectorField(type, Instances, type.GetField("spring"),
            ...
            fields.Add(new InspectorField(type, Instances, type.GetField("targetPosition"),
