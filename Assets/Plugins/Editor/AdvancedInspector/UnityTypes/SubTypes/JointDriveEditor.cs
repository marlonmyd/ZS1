...
namespace AdvancedInspector
{
    ...
    public class JointDriveEditor : InspectorEditor
    {
        protected override void RefreshFields()
        {
            ...
            fields.Add(new InspectorField(type, Instances, type.GetProperty("maximumForce"),
            ...
            fields.Add(new InspectorField(type, Instances, type.GetProperty("mode"),
            ...
            fields.Add(new InspectorField(type, Instances, type.GetProperty("positionDamper"),
            ...
            fields.Add(new InspectorField(type, Instances, type.GetProperty("positionSpring"),
