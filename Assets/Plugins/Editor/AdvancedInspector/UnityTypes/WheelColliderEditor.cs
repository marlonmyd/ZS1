...
namespace AdvancedInspector
{
    ...
    public class WheelColliderEditor : ColliderEditor
    {
        protected override void RefreshFields()
        {
            ...
            fields.Add(new InspectorField(type, Instances, type.GetProperty("suspensionSpring"), new ExpandableAttribute(),
            ...
            fields.Add(new InspectorField(type, Instances, type.GetProperty("forwardFriction"), new ExpandableAttribute(),
            ...
            fields.Add(new InspectorField(type, Instances, type.GetProperty("sidewaysFriction"), new ExpandableAttribute(),
