...
namespace AdvancedInspector
{
    ...
    public class CharacterJointEditor : JointEditor
    {
        protected override void RefreshFields()
        {
            ...
            fields.Add(new InspectorField(type, Instances, type.GetProperty("rotationDrive"), new InspectAttribute(InspectorLevel.Advanced), new ExpandableAttribute(),
                new DescriptorAttribute("Rotation Drive", "Undocumented Property", "")));
            fields.Add(new InspectorField(type, Instances, type.GetProperty("targetRotation"), new InspectAttribute(InspectorLevel.Advanced),
                new DescriptorAttribute("Target Rotation", "Undocumented Property", "")));
            fields.Add(new InspectorField(type, Instances, type.GetProperty("targetAngularVelocity"), new InspectAttribute(InspectorLevel.Advanced),
                new DescriptorAttribute("Target Angular Velocity", "Undocumented Property", "")));
        }
    }
}